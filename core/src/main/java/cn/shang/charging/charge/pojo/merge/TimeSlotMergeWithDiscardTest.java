...
public class TimeSlotMergeWithDiscardTest {
    ...
    static TestData getTestData() {
        ...
        // 时间段0：低优先级 02:00-04:00 (P2)
/*        TimeSlot slot0 = new TimeSlot("slot0",
                baseDate.plusHours(1),  // 01:00
...
//        slots.add(slot0);
    ...
    static TestData getTestData2() {
        return new TestData(
                parse("2025-01-01 07:21:00"),
                parse("2025-01-06 03:42:00"),
                new ArrayList<>(List.of(
                        new TimeSlot("s0", parse("2025-01-01 09:13:00"), parse("2025-01-01 09:42:00"), 1),
