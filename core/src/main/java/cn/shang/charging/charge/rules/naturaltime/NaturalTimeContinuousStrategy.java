 ...
 */
final class NaturalTimeContinuousStrategy extends AbstractTimeBasedRule<NaturalTimeConfig> {
    ...
    @Override
    protected boolean hasComplexFeatures(NaturalTimeConfig config) {
